// This is a generated file, modify: generate/templates/templates/bungit.js
...
// debug release.
try {
  rawApi = require("../build/Release/bungit.node");
}
catch (ex) {
  ...
  rawApi = require("../build/Debug/bungit.node");
}
...
var _Attr_foreachExt = _Attr.foreachExt;
_Attr.foreachExt = promisify(_Attr_foreachExt);
...
var _Filter_listApplyToBuffer = _Filter.listApplyToBuffer;
_Filter.listApplyToBuffer = promisify(_Filter_listApplyToBuffer);
...
var _Graph_reachableFromAny = _Graph.reachableFromAny;
_Graph.reachableFromAny = promisify(_Graph_reachableFromAny);
...
var _Index_create = _Index.create;
_Index.create = promisify(_Index_create);
...
var _Mempack_create = _Mempack.create;
_Mempack.create = promisify(_Mempack_create);

var _Mempack_reset = _Mempack.prototype.reset;
_Mempack.prototype.reset = promisify(_Mempack_reset);
...
var _Odb_hash = _Odb.hash;
_Odb.hash = promisify(_Odb_hash);
...
var _Odb_addMempackBackend = _Odb.prototype.addMempackBackend;
_Odb.prototype.addMempackBackend = promisify(_Odb_addMempackBackend);
...
var _Remote_connectExt = _Remote.prototype.connectExt;
_Remote.prototype.connectExt = promisify(_Remote_connectExt);
...
rawApi.RemoteConnectOptions = util.deprecate(function RemoteConnectOptions() {
  try {
    require("./deprecated/structs/RemoteConnectOptions").call(this, rawApi);
  }
  catch (error) { /* allow these to be undefined */ }
}, "Instantiation of RemoteConnectOptions is deprecated and will be removed in an upcoming version");
...
var _Repository_hashfile = _Repository.prototype.hashfile;
_Repository.prototype.hashfile = promisify(_Repository_hashfile);
...
var _Stash_saveWithOpts = _Stash.saveWithOpts;
_Stash.saveWithOpts = promisify(_Stash_saveWithOpts);
...
rawApi.StashSaveOptions = util.deprecate(function StashSaveOptions() {
  try {
    require("./deprecated/structs/StashSaveOptions").call(this, rawApi);
  }
  catch (error) { /* allow these to be undefined */ }
}, "Instantiation of StashSaveOptions is deprecated and will be removed in an upcoming version");
...
var _Submodule_dup = _Submodule.prototype.dup;
_Submodule.prototype.dup = promisify(_Submodule_dup);
...
var _Tree_getAllFilepaths = _Tree.prototype.getAllFilepaths;
_Tree.prototype.getAllFilepaths = promisify(_Tree_getAllFilepaths);
...
importExtension("diff_parse_options");
...
importExtension("filter_options");
...
importExtension("midx_writer");
importExtension("note");
importExtension("note_iterator");
importExtension("object");
importExtension("odb");
importExtension("odb_backend_loose_options");
importExtension("odb_backend_pack_options");
importExtension("odb_object");
importExtension("odb_options");
importExtension("oid");
...
importExtension("remote_callbacks");
importExtension("remote_connect_options");
...
importExtension("stash_apply_options");
importExtension("stash_save_options");
