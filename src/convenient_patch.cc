...
void ConvenientPatch::InitializeComponent(Napi::Object target, nodegit::Context *nodegitContext) {
  ...
  Napi::Function constructor_template = DefineClass(env, "ConvenientPatch", {
    InstanceMethod("hunks", &ConvenientPatch::Hunks, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("lineStats", &ConvenientPatch::LineStats, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("size", &ConvenientPatch::Size, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("oldFile", &ConvenientPatch::OldFile, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("newFile", &ConvenientPatch::NewFile, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("status", &ConvenientPatch::Status, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("isUnmodified", &ConvenientPatch::IsUnmodified, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("isAdded", &ConvenientPatch::IsAdded, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("isDeleted", &ConvenientPatch::IsDeleted, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("isModified", &ConvenientPatch::IsModified, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("isRenamed", &ConvenientPatch::IsRenamed, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("isCopied", &ConvenientPatch::IsCopied, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("isIgnored", &ConvenientPatch::IsIgnored, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("isUntracked", &ConvenientPatch::IsUntracked, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("isTypeChange", &ConvenientPatch::IsTypeChange, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("isUnreadable", &ConvenientPatch::IsUnreadable, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
    InstanceMethod("isConflicted", &ConvenientPatch::IsConflicted, static_cast<napi_property_attributes>(napi_writable | napi_configurable)),
  });
